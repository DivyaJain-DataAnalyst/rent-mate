...
<h3 align="center">Welcome to the rent-mate project! 😍<br>
We appreciate your interest in contributing.😊<br> </h3>

First off, thank you for considering contributing to **rent-mate!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
We expect all contributors to follow our [`Code of Conduct`](https://github.com/AYUSHDAS0601/rent-mate/blob/main/docs/CODEOFCONDUCT.md).
...
By contributing to this project, you agree that your contributions will be licensed under the [`Apache License`](https://github.com/AYUSHDAS0601/rent-mate/blob/main/docs/LICENSE.md).
...
* ⌛ Reviews may take **24–72 hours** depending on activity. Thanks for your patience!
 ...
 > For Any Query, Send DM on LinkedIn [Ayush Das](https://www.linkedin.com/in/ayush-das060105/).
...
- Take a look at the existing [Issues](https://github.com/AYUSHDAS0601/rent-mate/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/AYUSHDAS0601/rent-mate/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
...
This **CONTRIBUTING.md** was prepared with **❤️** by **Divya Jain** for **rent-mate** as part of the **NSoC'26 program.**
...
<h3 align="center">
Thank you for contributing to rent-mate 🌟
<br>
